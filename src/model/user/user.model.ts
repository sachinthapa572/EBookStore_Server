...
import { ROLES, type RoleType } from "@/enum/role.enum";
...
const userSchema = new Schema<userDoc, Record<string, unknown>, Methods>(
  {
    username: {
      type: String,
      trim: true,
...
export const UserModel = model<userDoc>("User", userSchema) as Model<
  userDoc,
